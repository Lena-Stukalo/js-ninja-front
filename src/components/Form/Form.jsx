...
const Form = ({ hero, operation, closeModal, params }) => {
  ...
  return (
    <form onSubmit={onSubmitForm} className={css.form}>
      ...
      <label htmlFor="real_name" className={css.label}>
        Real Name
      </label>
      <div className={css.modalWrapper}>
        <input
      ...
      <label htmlFor="catch_phrase" className={css.label}>
        Catch phrase
      </label>
      <div className={css.modalWrapper}>
        <input
      ...
      <label htmlFor="origin_description" className={css.label}>
      ...
      <label htmlFor="superpowers" className={css.label}>
        Superpowers
      </label>
      <div className={css.modalWrapper}>
        <textarea
      ...
      <label htmlFor="images" className={css.label}>
        Images
      </label>
      <div className={css.modalWrapper}>
        <input
