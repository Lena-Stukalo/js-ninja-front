...
const Hero = () => {
    ...
    return (
        data?<section className={css.container}>
          ...
          <Button text={'Update Hero'} todo={()=>{toggleModal(setShowUpadeModal)}} type={'button'}/>
          <Button text={'Delete Hero'} todo={()=>{toggleModal(setShowDeleteModal)}} denger={true} type={'button'}/>
          </div>
